...
As such, convex reformulations are more practical to solve than
convexifications of neural networks based on infinite-width relaxations
\citep{bengio2006convex}.
Additionally, while infinite-width neural networks provide powerful insights
into generalization behavior \citep{bach2017breaking}, convex reformulations
characterize only (and all) finite-width solutions \citep{wang2022hidden},
making them better for studying real-world models.
