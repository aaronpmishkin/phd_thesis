...
Convex versions of neural networks have a long history that originates in
linearizations based on large-width analyses.
...
Convexity of the final model is a by-product, rather than goal, of the
analysis.
...
this is achieved by showing that the effects of any (stochastic) gradient
updates vanish in the infinite-width limit, causing the network to remain at a
kernel specified by the initial gradients.
