...
The key challenge to developing better optimizers for neural networks is
non-convexity.
...
global optimality of the network weights.
...
For instance, deep ReLU networks are simply stacks of two-layer modules and
training by greedy sequential optimization of these blocks can be competitive
with end-to-end training \citep{belilovsky2019greedy}.
Two layer-ReLU networks are basic components of standard transformer blocks,
can be used to model self attention \citep{sahiner2022attention}, and are
widely used for reinforcement learning \citep{gaur2023global}, prediction on
edge devices \citep{teerapittayanon2017distributed}, and word-embeddings
\citep{mikolov2013word}.
As such, advances in training and theory for two-layer networks stands to
