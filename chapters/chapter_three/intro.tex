...
In contrast, solutions to the convex reformulation are completely
...
can be mapped onto the non-convex program to obtain a complete description
of the optimal set.
We obtain a similar characterization for all stationary points of the
non-convex program by leveraging their relationship with sub-sampled convex
reformulations \citep{wang2022hidden}.
...
we cover additional related work in \cref{sec:sol-fn-related-work}.
