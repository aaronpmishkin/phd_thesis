...
\begin{figure}[t]
    ...
    \label{fig:generalization-distributions}
\end{figure}
...
\begin{figure}[t]
    ...
    \caption{Implicit regularization of SGD and Adam on two datasets from the
        UCI repository with regularization strength \( \lambda = 10^{-4} \).
    ...
    \label{fig:stochastic-optimizer-distributions}
\end{figure}
...
\cref{fig:generalization-distributions} shows the distribution of test
...
\cref{fig:stochastic-optimizer-distributions} shows the distribution of
