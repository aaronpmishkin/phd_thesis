...
\begin{restatable}{lemma}{limitingActivationSet}\label{lemma:activation-patterns}
    ...
    finite limit, call it \( \calDl \), obtained by taking each hidden layer
    width \( d_{i} \rightarrow \infty \),
...
operate.
Let \( X^{(1)} = X \in \R^{n \times d_0} \) and recursively define
the tensor \( X^{(l+1)} \in \R^{n \times p_1 \times \cdots \times p_{l} \times d_0} \)
such that
...
\( l \), such as \( U^{(l)} \in \R^{d_0 \times p_1 \times \cdots \times p_{l-1}} \)
...
\begin{figure}[t]
    ...
    \caption{Illustration of layer elimination lemma for deep ReLU
        ...
        Each entry of the tensor \( \Tk \) is given by the
