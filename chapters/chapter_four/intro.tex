...
\cref{chapter:fast-optimization} allows us to prove that this problem is
equivalent to an (unconstrained) deep gated ReLU model.
...
\begin{itemize}
    ...
    \item A fully convex relaxation of these tensor programs which is equivalent
