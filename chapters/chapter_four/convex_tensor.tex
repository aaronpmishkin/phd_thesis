...
\begin{restatable}[Constraint Convexification]{proposition}{constraintConvexification}\label{prop:constraint-convexification}
    If \( d_l \geq 2 p_l d_{l+1} \) for every \( l \in [k-1]  \), then
    \( \calG^{(l)} = \calC^{(l)} \).
\end{restatable}
