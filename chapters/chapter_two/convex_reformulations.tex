...
\citet{pilanci2020convexnn} show that there is an equivalent convex
optimization problem with the same optimal value if \( m \geq m^* \) for some
\( m^* \leq n + 1 \).
Furthermore, \citet{wang2021hidden} showed that all optimal solutions to
