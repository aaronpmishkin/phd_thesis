...
In follow-up work to \citet{bai2022efficient},
\citet{feng2024chronos} propose Cronos, an ADMM solver for
...
Similar to \citet{sahiner2024burer}, \citet{prakhya2025convex} focus on
approximating a hard co-positive program arising as the convex reformulation 
of vector-output ReLU networks.
However, they develop a completely different convex reformulation which does
not rely on enumerating the space of activation patterns.
Since co-positive programming is NP-hard \citep{bomze200copositive},
\citet{prakhya2025convex} develop a semi-definite relaxation of
