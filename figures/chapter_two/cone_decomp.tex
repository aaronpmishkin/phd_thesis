...
\begin{tikzpicture}[scale=1,
    ...
    \begin{axis}[width=0.9\linewidth, height=6cm,
		...
		\node[label={0:$w_i$}, circle, fill, inner sep=1.8pt] (u) at (axis cs:2,1) {};
		\node[label={90:$v_i$}, circle, fill, inner sep=1.8pt] (v) at (axis cs:25/7+2, -25/21 - 2/3) {};
		\node[label={90:$u_i$}, circle, fill, inner sep=1.8pt] (w) at (axis cs:-25/7, 20/7) {};

		% labels
		\node[label={0:$\calK_i$}] at (axis cs:4,-2.5) {};
		\node[label={180:$-\calK_i$}] at (axis cs:-3.75,2.5) {};
