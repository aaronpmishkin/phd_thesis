\begin{tikzpicture}[scale=1,
    ...
    \begin{axis}[width=1.1\textwidth, height=8cm,
            ...
            ymin=0.5, ymax=7.5, y axis line style={-},
        ...
        \draw [->, style=arrow, draw=red, line width = 0.75mm] (hidden33) -- (output) node[pos=0.2,above right] {\large $\Tk_{i_0, j_1, \ldots, j_{L-1}, i_L}$};
